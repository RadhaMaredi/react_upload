        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              isBlog={false}
              title="DF-mSignal AI" 
              description="DF mSignal AI is a powerful signal management system that leverages advanced algorithms to automate critical safety data analysis. Our cloud-based solution offers great user experience, allowing one to effectively monitor, manage and analyze safety signals. DF mSignal AI is a modular, scalable and secure signal management system that can be integrated with leading safety databases."
              ghLink="https://github.com/soumyajit4419/Bits-0f-C0de"
              demoLink="https://msignals.dfoundry.ai/login"
            />
          </Col>
